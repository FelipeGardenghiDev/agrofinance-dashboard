...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-gray-200 hover:bg-gray-300 text-gray-900 hover:cursor-pointer',
      outline: 'bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 shadow-xs hover:cursor-pointer',
      ghost: 'bg-transparent hover:bg-gray-100 text-gray-700 hover:cursor-pointer',
