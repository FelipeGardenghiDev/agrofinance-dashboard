          ...
          <Card>
            <div className="text-center py-10 px-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Sua movimentação de{' '}
                <strong className="text-gray-900 dark:text-gray-100">{formatCurrency(executedTx.amount)}</strong> foi
              ...
              <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 rounded-xl p-6 text-left mb-8 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">Destino / Beneficiário:</span>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-3 flex justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-400">Novo Saldo Disponível:</span>
          ...
          <Card>
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 rounded-xl p-6 text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Valor da operação</p>
                <p className="text-4xl font-extrabold text-agro-azul-escuro dark:text-blue-400">
              ...
              <div className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900 rounded-xl p-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center border-t border-blue-200 dark:border-blue-900 pt-2">
                  <span className="text-blue-900 dark:text-blue-300 font-medium">Saldo após a operação:</span>
                  <span className="font-bold text-lg text-blue-950 dark:text-blue-200">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <label
                  ...
                  ${
                    operationType === 'pix'
                      ? 'border-agro-azul-escuro bg-blue-50 dark:bg-blue-950/40 text-agro-azul-escuro dark:text-blue-300 font-bold shadow-sm'
            ...
            {operationType === 'investment_rwa' && (
              <div className="bg-agro-branco dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 rounded-xl p-4 space-y-3">
                ...
                {selectedAsset && (
                  <div className="text-xs text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 p-3 rounded-lg border border-gray-100 dark:border-gray-700 flex justify-between">
                    <span>
                      Tokens em custódia:{' '}
            ...
            <div>
              ...
              {operationType === 'investment_rwa' && selectedAsset && parsedCurrentAmount > 0 && (
                <p className="mt-2 text-xs font-semibold text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-950/40 p-2 rounded-lg border border-green-200 dark:border-green-800">
